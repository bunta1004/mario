...
--タッチ用の背景
local screen = display.newRect( centerX, centerY, display.contentWidth, display.contentHeight  )
...
local  function timelitener( event )
...
timer.performWithDelay( 60000, timelitener)
--タップイベントの登録
